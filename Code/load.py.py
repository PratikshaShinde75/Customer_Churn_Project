...
# ---------------------- FOLDERS ----------------------
raw_folder = r'D:\SQL Project\Data\Unprocessed_data\output_by_month\output_by_month'             # RAW folder
processed_folder = r'D:\SQL Project\Data\Processed_data'  # PROCESSED folder
